...
function EditListing() {
	...
	useEffect(() => {
		...
		const fetchListing = async () => {
			...
			if (docSnap.exists()) {
				...
				// We are setting the fields to be filled to show the data they are currently holding - e.g. if the house is has 3 bedrooms and 1 bathroom then that will show instead of them both being 1 (the default)
				// We need to do the address manually because we chose for our field to be called "address" where as it's referred to as "location" by the databse so we have to seperately specify it as it's an alias
				setFormData({
					...docSnap.data(),
	...
	return (
		<div className="profile">
			<header>
				<p className="pageTitle">Edit Listing</p>
			</header>
